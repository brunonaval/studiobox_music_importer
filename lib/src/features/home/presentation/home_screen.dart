    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Row(
          children: [
            _SidebarNavigation(
              onDashboardTap: () => _scrollToSection(_dashboardKey),
              onLibraryTap: () => _scrollToSection(_libraryKey),
              onIncomingSongsTap: () => _scrollToSection(_incomingSongsKey),
              onReviewTap: () => _scrollToSection(_reviewKey),
              onOutputTap: () => _scrollToSection(_outputKey),
              onExecutionTap: () => _scrollToSection(_outputKey),
              onManifestTap: () => _scrollToSection(_manifestKey),
              onConfigurationTap: () => _scrollToSection(_cacheKey),
              onHelpTap: () => _scrollToSection(_statusKey),
            ),
            Expanded(
                                ...
                                children: [
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Wrap(
                                          ...
                                          runSpacing: 8,
                                          children: const [
                                            Chip(label: Text('Round 35')),
                                            Chip(label: Text('Fluxo seguro')),
                                          ],
                                        ),
                                  ...
                                  SizedBox(
                                    ...
                                    child: _TopMetricCard(
                                      ...
                                      lines: [
                                        '$progressPercent%',
                                        'Etapas: $completedSteps/7',
                                        'Arquivos: ${_incomingSongsScanResult?.totalCount ?? 0}',
                                        'Validos: ${_officialLibraryIndexResult?.validCount ?? 0}',
                                        'Pendentes: ${7 - completedSteps}',
                                      ],
                                    ),
                                  ),
                                ],
                          ...
                          child: Padding(
                            ...
                            child: Wrap(
                              ...
                              children: [
                                _WorkflowStepBadge(
                                  label: '1 Biblioteca',
                                  done: _officialLibraryIndexResult != null,
                                ),
                                _WorkflowStepBadge(
                                  label: '2 Novas musicas',
                                  done: _incomingSongsScanResult != null,
                                ),
                                _WorkflowStepBadge(
                                  label: '3 Sugestoes',
                                  done: _importSuggestionPlan != null,
                                ),
                                _WorkflowStepBadge(
                                  label: '4 Revisao',
                                  done: _importCandidateSelectionPlan != null,
                                ),
                                _WorkflowStepBadge(
                                  label: '5 Saida',
                                  done:
                                ...
                                _WorkflowStepBadge(
                                  label: '6 Execucao',
                                  done: _importOperationExecutionResult != null,
                                ),
                                _WorkflowStepBadge(
                                  label: '7 Manifesto',
                                  done: _importOperationManifest != null,
                                ),
                              ],
                            ),
                          ),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (_importCandidateSelectionMessage !=
                                        null) ...[
                                      const SizedBox(height: 8),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (_importCandidateEditPlan!
                                      .hasWarnings) ...[
                                    const SizedBox(height: 8),
                                    const Text('Avisos do plano:'),
                                    const SizedBox(height: 4),
                                    for (final warning
                                        in _importCandidateEditPlan!
                                            .warnings) ...[
                                      Text('- $warning'),
                                      const SizedBox(height: 2),
                                    ],
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (_importOutputValidationResult
                                            ?.hasErrors ??
                                        false) ...[
                                      const SizedBox(height: 8),
                                      const Text('Erros:'),
                                      for (final error
                                          in _importOutputValidationResult!
                                              .errors)
                                        Text('- $error'),
                                    ],
                                    if (_importOutputValidationResult
                                ...
                                children: [
                                  Wrap(
                                    ...
                                    children: [
                                      FilledButton.tonal(
                                        onPressed:
                                            _generateImportOperationDryRun,
                                        child: const Text(
                                  ...
                                  if (_importOperationDryRunMessage !=
                                      null) ...[
                                    const SizedBox(height: 8),
                                  ...
                                  if (_showImportOperationDryRun &&
                                    ...
                                    if (_importOperationExecutionResult !=
                                        null) ...[
                                      const SizedBox(height: 12),
                                      Text(
                                      ...
                                      FilledButton.tonal(
                                        onPressed:
                                            _generateImportOperationManifest,
                                        child: const Text(
                                      ...
                                      const SizedBox(height: 8),
                                      for (final item
                                          in _importOperationExecutionResult!
                                              .items
                                              .take(100)) ...[
                                        Card(
                                          child: Padding(
                                      ...
                                      if (_importOperationManifest != null) ...[
                                        ...
                                        const SizedBox(height: 8),
                                        Text(
                                          'ID: ${_importOperationManifest!.id}',
                                        ),
                                        const SizedBox(height: 4),
                                        Text(
                                  ...
                                  if (officialLibraryResult != null) ...[
                                    ...
                                    if (_duplicateCodeRepairPlan != null) ...[
                                      ...
                                      FilledButton.tonal(
                                        ...
                                        child: const Text(
                                          'Validar execucao do reparo',
                                        ),
                                      ),
                                    ],
                                    if (_duplicateRepairExecutionMessage !=
                                        null) ...[
                                      const SizedBox(height: 8),
                                    ...
                                    if (_duplicateCodeRepairPlan != null &&
                                      ...
                                      if (_duplicateCodeRepairPlan!
                                          .hasWarnings) ...[
                                        const SizedBox(height: 8),
                                        const Text('Avisos do plano:'),
                                        const SizedBox(height: 4),
                                        for (final warning
                                            in _duplicateCodeRepairPlan!
                                                .warnings) ...[
                                          Text('- $warning'),
                                          const SizedBox(height: 2),
                                        ],
                                      ...
                                      for (final group
                                          in _duplicateCodeRepairPlan!.groups
                                              .take(_repairGroupLimit)) ...[
                                        Text(
                                        ...
                                        for (final item in group.items.take(
                                          ...
                                          if (item.keepsOriginalCode) ...[
                                            ...
                                            Text(
                                              'Arquivo atual: ${item.displayPath}',
                                            ),
                                            Text(
                                              'Novo codigo: ${item.suggestedCode}',
                                            ),
                                            Text(
                                    ...
                                    if (_duplicateRepairExecutionResult !=
                                      ...
                                      const SizedBox(height: 6),
                                      for (final item
                                          in _duplicateRepairExecutionResult!
                                              .items
                                              .take(_executionItemsLimit)) ...[
                                        if (item.isRenamed) ...[
                                    ...
                                    if (officialLibraryResult
                                      ...
                                      FilledButton.tonal(
                                        onPressed:
                                            _generateInvalidFileRepairPlan,
                                        child: const Text(
                                    ...
                                    if (_invalidFileRepairPlan != null &&
                                      ...
                                      for (final item
                                        ...
                                        if (item.analysis.detectedArtist !=
                                            null) ...[
                                          const SizedBox(height: 2),
                                          Text(
                                        ...
                                        if (item.analysis.detectedTitle !=
                                            null) ...[
                                          const SizedBox(height: 2),
                                          Text(
                                    ...
                                    if (_invalidFileRepairExecutionMessage !=
                                        null) ...[
                                      const SizedBox(height: 8),
                                    ...
                                    if (_invalidRepairExecutionResult !=
                                        null) ...[
                                      const SizedBox(height: 12),
                                      Text(
                                      ...
                                      const SizedBox(height: 6),
                                      for (final item
                                          in _invalidRepairExecutionResult!
                                              .items
                                              .take(
                                                _invalidFileRepairItemsLimit,
                                              )) ...[
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (_incomingSongsFolderSelectionMessage !=
                                      null) ...[
                                    const SizedBox(height: 8),
                                  ...
                                  if (_incomingSongsScanResult != null) ...[
                                    ...
                                    if (_incomingSongsScanResult!
                                      ...
                                      const SizedBox(height: 4),
                                      for (final warning
                                          in _incomingSongsScanResult!
                                              .warnings) ...[
                                        Text('- $warning'),
                                        const SizedBox(height: 2),
                                      ],
                                    ],
                                    if (_incomingSongsScanResult!.totalCount ==
                                        0) ...[
                                      const SizedBox(height: 8),
                                      const Text(
                                      ...
                                      const SizedBox(height: 4),
                                      for (final file
                                          in _incomingSongsScanResult!.files
                                              .take(20)) ...[
                                  ...
                                  if (_importSuggestionPlan != null &&
                                    ...
                                    const SizedBox(height: 8),
                                    Text(
                                      'Total: ${_importSuggestionPlan!.totalCount}',
                                    ),
                                    const SizedBox(height: 4),
                                    Text(
                                      'Prontos: ${_readyImportCandidates().length}',
                                    ),
                                    const SizedBox(height: 4),
                                    Text(
                                    ...
                                    if (_showReadyImportCandidates) ...[
                                      ...
                                      for (final candidate
                                          in _readyImportCandidates().take(
                                            50,
                                          )) ...[
                                        ...
                                        const Text('Original:'),
                                        Text(
                                          candidate.analysis.originalFileName,
                                        ),
                                        const SizedBox(height: 2),
                                    ...
                                    if (_showBlockedImportCandidates) ...[
                                      ...
                                      if (_blockedImportCandidates().isEmpty)
                                        const Text(
                                          'Nenhum candidato bloqueado.',
                                        ),
                                      if (_blockedImportCandidates().length >
                                          50)
                                        Text(
                                          'Exibindo os primeiros 50 de ${_blockedImportCandidates().length} candidatos.',
                                        ),
                                      for (final candidate
                                          in _blockedImportCandidates().take(
                                            50,
                                          )) ...[
                                        const Text('Bloqueado'),
                                        const SizedBox(height: 2),
...
class _SidebarNavigation extends StatelessWidget {
  const _SidebarNavigation({
    ...
    required this.onIncomingSongsTap,
    required this.onReviewTap,
    required this.onOutputTap,
    required this.onExecutionTap,
  ...
  final VoidCallback onIncomingSongsTap;
  final VoidCallback onReviewTap;
  final VoidCallback onOutputTap;
  final VoidCallback onExecutionTap;
  final VoidCallback onManifestTap;
  ...
  Widget build(BuildContext context) {
    final items = <({String label, VoidCallback onTap})>[
      (label: 'Dashboard', onTap: onDashboardTap),
      (label: 'Biblioteca', onTap: onLibraryTap),
      (label: 'Novas musicas', onTap: onIncomingSongsTap),
      (label: 'Revisao', onTap: onReviewTap),
      (label: 'Saida', onTap: onOutputTap),
      (label: 'Execucao', onTap: onExecutionTap),
      (label: 'Manifesto', onTap: onManifestTap),
    ];
...
class _WorkflowStepBadge extends StatelessWidget {
  const _WorkflowStepBadge({required this.label, required this.done});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: done ? const Color(0xFF1B3A2A) : const Color(0xFF1B2130),
