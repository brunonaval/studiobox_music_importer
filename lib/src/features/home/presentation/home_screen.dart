                              ...
                              children: [
                                ...
                                if (officialLibraryResult != null) ...[
                                  ...
                                  if (_showInvalidFiles) ...[
                                    ...
                                    if (officialLibraryResult
                                      ...
                                      for (final invalidFile
                                          in officialLibraryResult.invalidFiles
                                  ...
                                  if (_duplicateRepairExecutionPlan != null &&
                                    ...
                                    const SizedBox(height: 6),
                                    for (final item
                                        in _duplicateRepairExecutionPlan!.items
                                  ...
                                  if (_invalidRepairExecutionResult !=
                                    ...
                                    const SizedBox(height: 6),
                                    for (final item
                                        in _invalidRepairExecutionResult!.items
                                            .take(
                                              _invalidFileRepairItemsLimit,
                                            )) ...[
                                      if (item.isRenamed) ...[
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (_incomingSongCleaningPreviewPlan != null &&
                                  ...
                                  const SizedBox(height: 4),
                                  for (final item
                                      in _incomingSongCleaningPreviewPlan!.items
                                          .take(50)) ...[
                                    const Text('Arquivo:'),
                                    Text(item.displayPath),
                                    const SizedBox(height: 2),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 8),
                                const Text(
                                  'Round 35 - Dashboard visual da interface',
                                ),
                                const SizedBox(height: 4),
                                const Text(
                                  'Estado: Interface redesenhada em dashboard desktop, mantendo o motor seguro existente.',
                                ),
                              ],
                            ),
                          ),
